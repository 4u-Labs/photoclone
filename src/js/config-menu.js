const menuDefinition = [
	{
		...
		children: [
			...
			},
			{
				...
				ellipsis: true,
				target: 'file/recent_projects.show_recent'
			},
			{
				divider: true
			},
			...
			},
			{
				...
				ellipsis: true,
				shortcut: 'H',
				target: 'file/open.search_hub'
			},
			{
				name: 'Search Free Stock Photos',
				ellipsis: true,
				target: 'file/open.search'
			},
			{
				name: 'Search Vector Illustrations',
				ellipsis: true,
				target: 'file/open.search_illustrations'
			},
			{
				name: 'Search Global Icons (+200k)',
				ellipsis: true,
				target: 'file/open.search_icons'
			},
			{
				name: 'Search 4K Wallpapers',
				ellipsis: true,
				target: 'file/open.search_wallpapers'
			},
			{
				name: 'Search Transparent Stickers',
				ellipsis: true,
				target: 'file/open.search_stickers'
			},
			{
				name: 'Search 3D & HD Emojis',
				ellipsis: true,
				target: 'file/open.search_emojis'
			},
			{
				divider: true
			},
			{
				name: 'Export for WhatsApp & Web',
				shortcut: 'Alt + S',
				target: 'file/save.export_optimized'
			},
			{
				name: 'Export',
				ellipsis: true,
	...
	},
	{
		...
		children: [
			...
			{
				name: 'New QR Code / PIX',
				ellipsis: true,
				target: 'tools/qrcode.qrcode'
			},
			{
				divider: true
			},
	...
	},
	{
		...
		children: [
			{
				name: '🌟 Shapes, Elements & Frames',
				ellipsis: true,
				target: 'tools/shape.show_shapes'
			},
			{
				name: 'Stock Photos',
				ellipsis: true,
				target: 'tools/media.search'
			},
			{
				name: 'QR Code & PIX Generator',
				ellipsis: true,
				target: 'tools/qrcode.qrcode'
			},
			{
		...
		children: [
			{
				...
				target: 'ai/tools.remover_fundo_ai'
			},
			{
				name: 'Remove Background by Color (Click)',
				target: 'ai/tools.remover_fundo_cor'
			},
			{
				name: 'Colorize (AI)',
				target: 'ai/tools.colorizar_ai'
			},
			{
				name: 'Upscale 2x (AI)',
				target: 'ai/tools.upscale_ai'
			},
			{
				divider: true
			},
			{
				name: 'Enrich (HDR Effect)',
				ellipsis: true,
				target: 'effects/enrich.enrich'
			},
			{
			...
			{
				name: 'Color Boost (Vibrance)',
				ellipsis: true,
				target: 'effects/vibrance.vibrance'
			},
			{
				name: 'Vintage / Retro Effect',
				ellipsis: true,
				target: 'effects/vintage.vintage'
			},
			{
			...
			{
				name: 'Selective Focus (Tilt Shift)',
				ellipsis: true,
				target: 'effects/tilt_shift.tilt_shift'
			},
			{
	...
	{
		name: 'Share & Distribute',
		children: [
			{
				name: 'Share on WhatsApp',
				target: 'share/share.whatsapp'
			},
			{
				name: 'Share on Facebook',
				target: 'share/share.facebook'
			},
			{
				name: 'Share on X (Twitter)',
				target: 'share/share.twitter'
			},
			{
				name: 'Invite Friends',
				target: 'share/share.invite'
			}
		]
	},
	{
